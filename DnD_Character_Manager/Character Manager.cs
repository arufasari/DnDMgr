...
namespace DnD_Long
{
    public partial class Character_Manager : Form
    {
        ...
        {
            InitializeComponent();
            DnD_LongDBDataSetTableAdapters.CharactersTableAdapter characterTableAdapter =
                new DnD_LongDBDataSetTableAdapters.CharactersTableAdapter();
        ...
        {
            DnD_LongDBDataSetTableAdapters.weaponsNArmorTableTableAdapter weaponsTableAdapter =
                new DnD_LongDBDataSetTableAdapters.weaponsNArmorTableTableAdapter();
            DnD_LongDBDataSetTableAdapters.equipmentTableTableAdapter equipAdapter =
                new DnD_LongDBDataSetTableAdapters.equipmentTableTableAdapter();
            DnD_LongDBDataSetTableAdapters.TreasureTableTableAdapter treasureAdapter =
                new DnD_LongDBDataSetTableAdapters.TreasureTableTableAdapter();
        ...
        {
            DnD_LongDBDataSetTableAdapters.spellsTableTableAdapter spellTableAdapt =
                new DnD_LongDBDataSetTableAdapters.spellsTableTableAdapter();
        ...
        {
            DnD_LongDBDataSetTableAdapters.RacesTableAdapter raceTableAdapter =
                new DnD_LongDBDataSetTableAdapters.RacesTableAdapter();
        ...
        private void yesQuitButton_Click_1(object sender, EventArgs e)
        {
            ...
            DnD_LongDBDataSetTableAdapters.TreasureTableTableAdapter treasureTableAdapt =
                new DnD_LongDBDataSetTableAdapters.TreasureTableTableAdapter();
            DnD_LongDBDataSetTableAdapters.equipmentTableTableAdapter equipAdapt =
                new DnD_LongDBDataSetTableAdapters.equipmentTableTableAdapter();
            DnD_LongDBDataSetTableAdapters.spellsTableTableAdapter spelladapt =
                new DnD_LongDBDataSetTableAdapters.spellsTableTableAdapter();
            DnD_LongDBDataSetTableAdapters.weaponsNArmorTableTableAdapter weaponsAdapt =
                new DnD_LongDBDataSetTableAdapters.weaponsNArmorTableTableAdapter();
            ///
            ///
            ///
